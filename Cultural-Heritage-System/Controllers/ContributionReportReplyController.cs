...
namespace Cultural_Heritage_System.Controllers
{
    ...
    [ApiController]
    public class ContributionReportReplyController : ControllerBase
    {
        private readonly IContributionReportReplyService _reportReplyService;

        public ContributionReportReplyController(IContributionReportReplyService reportReplyService)
        {

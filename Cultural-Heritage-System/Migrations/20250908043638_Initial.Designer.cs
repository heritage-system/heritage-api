...
namespace Cultural_Heritage_System.Migrations
{
    ...
    [Migration("20250908043638_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cultural_Heritage_System.Models.Contribution", b =>
                {
                    ...
                    b.Property<string>("TitleUnsigned")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("title_unsigned");
            ...
            modelBuilder.Entity("Cultural_Heritage_System.Models.Contributor", b =>
                {
                    ...
                    b.Property<string>("ExpertiseUnsigned")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("expertise_unsigned");
            ...
            modelBuilder.Entity("Cultural_Heritage_System.Models.RefreshToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Cultural_Heritage_System.Models.ReportReply", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Cultural_Heritage_System.Models.User", b =>
                {
                    ...
                    b.Property<string>("UserNameUnsigned")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("user_name_unsigned");
            ...
            modelBuilder.Entity("Cultural_Heritage_System.Models.Contributor", b =>
                {
                    b.HasOne("Cultural_Heritage_System.Models.User", "User")
                        .WithOne("Contributor")
                        .HasForeignKey("Cultural_Heritage_System.Models.Contributor", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Cultural_Heritage_System.Models.Favorite", b =>
                {
                    ...
                    b.HasOne("Cultural_Heritage_System.Models.User", null)
                        .WithMany("Favorites")
            ...
            modelBuilder.Entity("Cultural_Heritage_System.Models.Profile", b =>
                {
                    b.HasOne("Cultural_Heritage_System.Models.User", "User")
                        .WithOne("Profile")
                        .HasForeignKey("Cultural_Heritage_System.Models.Profile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Cultural_Heritage_System.Models.ReportReply", b =>
                {
                    b.HasOne("Cultural_Heritage_System.Models.Report", "Report")
                        .WithMany("Replies")

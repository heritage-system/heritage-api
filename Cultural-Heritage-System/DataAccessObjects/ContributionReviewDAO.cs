...
{
    public class ContributionReviewDAO : BaseDAO<ContributionReview>
    {
                private readonly ILogger<ContributionReviewDAO> _logger;

        public ContributionReviewDAO(AppDbContext context, ILogger<ContributionReviewDAO> logger)
            : base(context)
        {
            _logger = logger;
        }

...
{
    public class ContributionSaveDAO : BaseDAO<ContributionSave>
    {
        private readonly ILogger<ContributionSaveDAO> _logger;

        public ContributionSaveDAO(AppDbContext context, ILogger<ContributionSaveDAO> logger)
            : base(context)
        {
            _logger = logger;
        }

...
{
    public class ContributorDAO : BaseDAO<Contributor>
    {
        private readonly ILogger<ContributorDAO> _logger;

        public ContributorDAO(AppDbContext context, ILogger<ContributorDAO> logger)
            : base(context)
        {
            _logger = logger;
        }
